...
@Component
public class RepartitionVisiteReportManager extends ActivatedReportManager {
	...
	public ReportDefinition constructReportDefinition() {
		...
		String rawSql = getSqlString("org/openmrs/module/commonreports/sql/repartitionVisite.sql");
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		ReportDesign reportDesign = ReportManagerUtil.createExcelTemplateDesign("92b1ace5-e49a-4421-acef-baa381c9d549",
				reportDefinition, "org/openmrs/module/commonreports/reportTemplates/repartitionVisiteReportTemplate.xls");
