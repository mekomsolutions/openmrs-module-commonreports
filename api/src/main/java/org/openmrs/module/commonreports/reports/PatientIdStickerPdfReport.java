...
import static org.openmrs.module.commonreports.reports.PatientIdStickerReportManager.REPORT_DESIGN_UUID;
...
public class PatientIdStickerPdfReport {
	...
	public byte[] getBytes(Patient patient, Set<Encounter> encounters) throws ContextAuthenticationException,
		...
		StreamSource xslTransformStream = new StreamSource(
		        OpenmrsClassLoader.getInstance().getResourceAsStream(CommonReportsConstants.PATIENT_ID_STICKER_XSL_PATH));
