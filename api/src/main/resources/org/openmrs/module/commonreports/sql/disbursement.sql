...
SELECT 
    '80% (of women aged 30 to 49 years with CCS form filled out for the first time) were VIA positive and referred' AS 'Indicator',
    CASE 
        WHEN SUM(CASE 
...
WHERE 
    (
        ...
        AND (o_m.obs_datetime < DATE_SUB(:endDate, INTERVAL 3 WEEK)) 
