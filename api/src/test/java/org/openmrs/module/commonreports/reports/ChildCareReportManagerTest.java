...
public class ChildCareReportManagerTest extends BaseModuleContextSensitiveMysqlBackedTest {
	...
	private Map<String, Integer> getColumnValues() {
		...
		map.put("Children seen for the first time (MUAC <115).Children from 24 months to 59 months - F", 1);
		map.put("Children seen for the first time (MUAC <115).Children from 24 months to 59 months - Total", 1);
